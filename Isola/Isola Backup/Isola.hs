...
-- isolaHumanComp: Single match human against computer players
...
main = do nextMove <- newEmptyMVar
          ...
          --isolaCompComp (P1.getName, P1.getMove) (P2.getName, P2.getMove) nextMove
          isolaHumanComp (P1.getName, P1.getMove) nextMove
          --isolaTournament [(P1.getName, P1.getMove), (P2.getName, P2.getMove), (P3.getName, P3.getMove), (P4.getName, P4.getMove)] nextMove
          hFlush stdout
